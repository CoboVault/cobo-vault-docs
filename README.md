...
## Clone
    ...
    git clone git@github.com:CoboVault/cobo-vault-docs.git

## Structure

`hardware`: Schematic and BOM for Cobo Vault

## Issues and PRs
Please submit any issues  [here](https://github.com/CoboVault/cobo-vault-docs/issues). PRs are also welcome!
